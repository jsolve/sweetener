...
public class CollectionsTest {
    ...
    public void shouldReturnGroupsForMultiKey() {
        ...
        assertThat(groups.keySet()).containsOnly(new GroupKey(3, FieldOfStudy.MATHS, Department.AEI),
                new GroupKey(3, FieldOfStudy.BIOINFORMATICS, Department.AEI),
                new GroupKey(5, FieldOfStudy.BIOINFORMATICS, Department.MT),
                new GroupKey(7, FieldOfStudy.COMPUTER_SCIENCE, Department.AEI));
        assertThat(groups.get(new GroupKey(3, FieldOfStudy.MATHS, Department.AEI))).onProperty("lastName").contains(
                "Deep");
        assertThat(groups.get(new GroupKey(3, FieldOfStudy.BIOINFORMATICS, Department.AEI))).onProperty("lastName")
                .contains("Duke", "Knee");
        assertThat(groups.get(new GroupKey(5, FieldOfStudy.BIOINFORMATICS, Department.MT))).onProperty("lastName")
                .contains("Hunt");
        assertThat(groups.get(new GroupKey(7, FieldOfStudy.COMPUTER_SCIENCE, Department.AEI))).onProperty("lastName")
                .contains("Sky");
    }
