...
public class ReflectionsTest {
    ...
    public void shouldGetMethodsSatisfyingCondtion() throws Exception {
        ...
        assertThat(methods).contains(heroGetIdMethod, heroGetFirstNameMethod, heroGetLastNameMethod,
                heroGetNicknameMethod);
    }
    ...
    public void shouldCreateObjectWithPrivateDefaultConstructor() {
        // when
        ClassWithPrivateDefaultConstructor instance = Reflections
                .tryToCreateNewInstance(ClassWithPrivateDefaultConstructor.class);
    ...
    public void shouldCreateObjectWithPrivateNonDefaultConstructor() throws NoSuchMethodException {
        // given
        int parameter = 0;
        Constructor<ClassWithPrivateNonDefaultConstructor> constructor = ClassWithPrivateNonDefaultConstructor.class
