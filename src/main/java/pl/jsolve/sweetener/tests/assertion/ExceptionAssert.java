...
public final class ExceptionAssert {
	...
	throw new AssertionError("Expected exception message [" + exceptionMessage + "] but was ["
	...
	throw new AssertionError("Expected exception message [" + throwable.getMessage() + "] to contain ["
		+ message + "]");
    }
}