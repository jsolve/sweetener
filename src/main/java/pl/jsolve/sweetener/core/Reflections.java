...
public final class Reflections {
    ...
    public static List<Constructor<?>> getConstructorsSatisfyingCondition(Object object,
    ...
    public static <T> T tryToCreateNewInstance(Constructor constructor, Object... params) {
        try {
            ...
            throw new InstanceCreationException("Could not create an instance of class "
