...
public class Strings {
    ...
    private static StringBuilder insertCentre(String sourceObject, String content, int numberOfPadding,
    ...
    private static StringBuilder insertLeftOrRight(String sourceObject, String content, int numberOfPadding,
            PaddingType paddingType) {
        StringBuilder sb = new StringBuilder(sourceObject);
